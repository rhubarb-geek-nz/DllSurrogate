...
$Version = (Get-Item bin\x64\RhubarbGeekNzDllSurrogate.dll).VersionInfo.ProductVersion
$PackageId = 'rhubarb-geek-nz.DllSurrogate'
...
try
{
	...
	Copy-Item 'disptlb\bin\x86\RhubarbGeekNzDllSurrogate.dll' 'base\lib\netstandard2.0\RhubarbGeekNzDllSurrogate.dll'
